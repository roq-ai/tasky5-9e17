  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Tasky5, your new companion for managing tasks effectively. Say goodbye to stress, embrace the smart way to organize your to-do list."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Tasky5, your new companion for managing tasks effectively. Say goodbye to stress, embrace the smart way to organize your to-do list.`}
            </Text>
            <Box
